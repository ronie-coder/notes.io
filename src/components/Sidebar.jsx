...
const Sidebar = () => {
   ...
   useEffect(() => {
      console.log('isCreateTaskOpen:', isCreateTaskOpen);
    }, [isCreateTaskOpen]);
  return (
   <>
    <aside id="logo-sidebar" className=" fixed  z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Pending Tasks</span>
         ...
         {isBetaMessageOpen && <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
         ...
         <p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
            Notes.io is built using electron.js and is under development. Please follow this github link to visit . 
         </p>
         <button type="button" class="text-white bg-zinc-700 hover:bg-zinc-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-zinc-900 dark:hover:bg-zinc-900 dark:focus:ring-blue-800">
Go to Github
...
<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
        ...
        <div className='absolute bottom-5 flex gap-2 items-center ' >
            <motion.div  whileHover={{rotate:45}}   href="" className=' '  >
            <BiPlus className=' cursor-pointer'  size={60} color='white' onClick={()=>setIsCreateTaskOpen(!isCreateTaskOpen)}/>
            
         </motion.div>
         <span className='text-[20px] cursor-pointer'>Create a note</span>
         </div>
            
         
   {/* <div className=' absolute  -translate-x-[-100%] -translate-y-[100%] '>   
<div class="mb-6 ">
...
{isCreateTaskOpen && <CreatePost isCreateTaskOpen={isCreateTaskOpen} setIsCreateTaskOpen={setIsCreateTaskOpen}></CreatePost>
}
</>
  )
}
